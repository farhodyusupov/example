...
class ScanActivity : BaseActivity(), IScanView.Proxy {
    ...
    override fun prepare() {
        ...
        val imageCount: TextView = findViewById(R.id.imageCount)
        shut.setOnClickListener {
            imageCount.text = counter.toString()
...
//need to uncomment onimageSelected
...
//this func should choose 5 images in a time
